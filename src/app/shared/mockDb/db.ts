...
createDb(){
	...
	{id:'1',name:'Nathan Diaz',groups:['0'],username:'Nate',thumbnail:'nate',country:'USA',isOnline:false},
	...
	{id:'6',name:'Jonathan Jones',groups:['1'],username:'Bones',thumbnail:'jones',country:'USA',isOnline:false},
	{id:'7',name:'Brok Lesnar',groups:['1'],username:'Broccoli',thumbnail:'broklesnar',country:'USA',isOnline:false},
...
thumbnail:'angular_up_and_running',topics:['AngularJS'],price:6,release:this.getDate('July','2018')},
...
thumbnail:'learning_angular_second_e',topics:['Angular 5','TypeScript'],price:12.2,release:this.getDate('December','2017')},
...
price:33.6,release:this.getDate('November','2017')},
...
thumbnail:'switching_to_angular',price:8.25,release:this.getDate('October','2017')},
...
thumbnail:'nodejs_mongodb_angular_webdevelopment',price:10,release:this.getDate('October','2017')},
...
thumbnail:'effective_javascript',price:5,release:this.getDate('November','2012')},
...
thumbnail:'modular_javascript',price:18.25,release:this.getDate('June','2018')},
...
{id:1,buyer:'1',products:['2','1'],status:'submitted',createdAt:this.getDate('January','2018','2'),amount:2,total:0},
{id:2,buyer:'0',products:['1','0'],status:'cancelled',createdAt:this.getDate('December','2018','12'),amount:2,total:0},
{id:3,buyer:'4',products:['4','2'],status:'submitted',createdAt:this.getDate('January','2018','4'),amount:2,total:0},
{id:4,buyer:'3',products:['5','6'],status:'awaiting payment',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:5,buyer:'5',products:['5','6'],status:'submitted',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:6,buyer:'2',products:['5','6'],status:'finalized',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:7,buyer:'3',products:['5','6'],status:'cancelled',createdAt:this.getDate('August','2018','22'),amount:2,total:0},
{id:8,buyer:'8',products:['5','6'],status:'submitted',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:9,buyer:'1',products:['5','6'],status:'awaiting payment',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:10,buyer:'0',products:['5','6'],status:'finalized',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:11,buyer:'3',products:['3','6'],status:'finalized',createdAt:this.getDate('January','2018','2'),amount:2,total:0},
{id:12,buyer:'4',products:['2','6'],status:'submitted',createdAt:this.getDate('January','2018','22'),amount:2,total:0},
{id:13,buyer:'2',products:['5','6','1'],status:'finalized',createdAt:this.getDate('August','2018','22'),amount:3,total:0},
{id:14,buyer:'4',products:['5','6','1'],status:'finalized',createdAt:this.getDate('January','2018','22'),amount:3,total:0},
{id:15,buyer:'1',products:['5','1','2'],status:'finalized',createdAt:this.getDate('March','2018','22'),amount:3,total:0}

];

	return {customers,customer_groups,products,orders};
}
